...
<div class="container">
    ...
    <form action="{{ route('siswa.kegiatan.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label>Tanggal</label>
            <input type="date" name="tanggal" class="form-control border px-2">
        </div>
        @error('tanggal')
        ...
        <div class="mb-3">
            ...
            <input type="time" name="jam_mulai" class="form-control border px-2">
        </div>
        @error('jam_mulai')
        <div class="text-danger">{{ $message }}</div>
        @enderror
        <div class="mb-3">
            ...
            <input type="time" name="jam_selesai" class="form-control border px-2">
        </div>
        @error('jam_selesai')
        <div class="text-danger">{{ $message }}</div>
        @enderror
