...
<head>
  ...
  <title>Juhar pkl - @yield('title', 'Jurnal App')</title>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-1">
          ...
          <!-- Accordion Content -->
          <ul class="nav flex-column ms-3 mt-1 {{ request()->routeIs('admin.Pembimbing.') || request()->routeIs('admin.pembimbing.') ? '' : 'd-none' }}" id="kelolaUserMenu">
            <li class="nav-item">
              <a href="{{ route('admin.pembimbing.index') }}"
                ...
                <span class="nav-link-text ms-1">Kelola pembimbbing</span>
              </a>
            </li>
            <li class="nav-item">
      ...
      <div class="container-fluid">
        <div class="row align-items-center justify-content-between">
          <div class="col-lg-6 mb-lg-0 mb-4 text-muted">
            ...
            </script>, made with ❤️ for Kasir App
          </div>
        </div>
      </div>
    </footer>
